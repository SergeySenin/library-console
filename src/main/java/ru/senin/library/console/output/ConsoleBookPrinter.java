...
/**
 * Предметный printer консольных сценариев, связанных с книгами.
 *
 * <p>Печатает список книг, экраны регистрации, поиска, редактирования и удаления, а также
 * сообщения об успешных результатах этих операций.
 * Класс обслуживает полный текущий CRUD- и search-поток книжного слоя.
 *
 * <p>Класс не отвечает за стартовый экран приложения, главное меню и общие сообщения верхнего уровня.
 * Эта граница ответственности отделяет предметный вывод книг от общего каркаса приложения.
 */
